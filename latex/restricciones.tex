...
\begin{enumerate}
    ...
    \item El atributo edad en las competencias que lo tengan puede ser "Juveniles" ó "Adulto".
    \item Todo competidor inscripto en una competencia(individual o por equipo) , la cual tenga como atributo edad el valor "Juveniles", deberá tener
    una edad entre 14 y 17. Si la competencia tiene como valor "Adulto" entonces tendrá que estar entre
    18 y 35.
    \item Todo competidor inscripto en una competencia(individual o por equipo) que tenga el atributo peso, deberá tener
    un peso menor al de la competencia.
