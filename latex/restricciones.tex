...
\begin{enumerate}
    ...
    \item El atributo edad en las competencias, que lo tengan, debe ser ``Juveniles" o ``Adultos" o ``Veteranos".
    \item Todo competidor inscripto en una competencia, la cual tenga como valor del atributo edad ``Juveniles", deberá tener
    una edad entre 14 y 17. Si la competencia tiene como valor ``Adultos" entonces tendrá que estar entre
    18 y 35. Por ultimo si la competencia tiene como valor ``Veteranos" entonces la edad deberá ser mayor a 35.
    \item Todo competidor inscripto en una competencia que tenga el atributo peso, deberá tener
    un peso menor o igual al de la competencia.
\end{enumerate}
