...
CK = \{IdCompetencia\}\\
\\
\textbf{CompetenciaCombateEquipo}(\dashuline{\uline{IdCompetencia}}, Edad, \dashuline{PrimerLugar}, \dashuline{SegundoLugar}, \dashuline{TercerLugar})\\
PK = \{IdCompetencia\}\\
CK = \{IdCompetencia\}\\
FK = \{IdCompetencia, PrimerLugar, SegundoLugar, TercerLugar\}\\
\\
\textbf{CompetenciaIndividual}(\dashuline{\uline{IdCompetencia}}, Modalidad, Graduacion, \dashuline{PrimerLugar}, \dashuline{SegundoLugar}, \dashuline{TercerLugar})\\
PK = \{IdCompetencia\}\\
CK = \{IdCompetencia\}\\
FK = \{IdCompetencia, PrimerLugar, SegundoLugar, TercerLugar\}\\
\\
\textbf{CompetenciaSalto}(\dashuline{\uline{IdCompetencia}}, Edad)\\
PK = \{IdCompetencia\}\\
CK = \{IdCompetencia\}\\
FK = \{IdCompetencia\}\\
\\
\textbf{CompetenciaFormas}(\dashuline{\uline{IdCompetencia}}, Edad)\\
PK = \{IdCompetencia\}\\
CK = \{IdCompetencia\}\\
FK = \{IdCompetencia\}\\
\\
\textbf{CompetenciaCombateIndividual}(\dashuline{\uline{IdCompetencia}}, Edad, Peso)\\
PK = \{IdCompetencia\}\\
CK = \{IdCompetencia\}\\
FK = \{IdCompetencia\}\\
\\
\textbf{CompetenciaRotura}(\dashuline{\uline{IdCompetencia}})\\
PK = \{IdCompetencia\}\\
CK = \{IdCompetencia\}\\
FK = \{IdCompetencia\}\\
\\
